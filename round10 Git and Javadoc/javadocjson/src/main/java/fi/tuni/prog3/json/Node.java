...
public abstract class Node {
  ...
  /**
   * The line separator used in the JSON string.
   */
  ...
  /**
   * The line separator used in between elements of an array or object.
   */
  private static final String CNL = "," + System.lineSeparator();

  /**
   * Prints a JSON node as a string.
   *
   * @param node the node to be printed.
   * @param sb the StringBuilder used to build the JSON string.
   * @param depth the current depth of the node in the JSON structure.
   */
